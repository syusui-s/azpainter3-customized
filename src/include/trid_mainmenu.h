...
TRMENU_EDIT_DRAWCOL_TO_BKGNDCOL,

/* 選択範囲 */

TRMENU_SEL_RELEASE = 1200,
TRMENU_SEL_ALL,
TRMENU_SEL_INVERSE,
TRMENU_SEL_EXPAND,
TRMENU_SEL_COPY,
...
TRMENU_SEL_LAYER_OPACITY,
TRMENU_SEL_LAYER_DRAWCOL,
...
TRMENU_LAYER_ID_TOP = 2000,
TRMENU_LAYER_ID_BOTTOM = 2999,

TRMENU_LAYER_NEW = 2000,
TRMENU_LAYER_NEW_FOLDER,
TRMENU_LAYER_NEW_FROM_FILE,
TRMENU_LAYER_NEW_ABOVE,
TRMENU_LAYER_COPY,
TRMENU_LAYER_DELETE,
TRMENU_LAYER_ERASE,
TRMENU_LAYER_DROP,
...
//設定
TRMENU_LAYER_OPT_OPTION = 2100,
TRMENU_LAYER_OPT_TYPE,
TRMENU_LAYER_OPT_COLOR,

//一括変換
TRMENU_LAYER_BATCH_TONE_LINES = 2150,

//編集
TRMENU_LAYER_EDIT_REV_HORZ = 2200,
TRMENU_LAYER_EDIT_REV_VERT,
TRMENU_LAYER_EDIT_ROTATE_LEFT,
TRMENU_LAYER_EDIT_ROTATE_RIGHT,

//表示
TRMENU_LAYER_VIEW_ALL_SHOW = 2300,
...
//フォルダ
TRMENU_LAYER_FOLDER_CHECKED_MOVE = 2400,
TRMENU_LAYER_FOLDER_CLOSE_EX_CUR,
TRMENU_LAYER_FOLDER_ALL_OPEN,

//フラグ
TRMENU_LAYER_FLAG_OFF_FILL = 2500,
TRMENU_LAYER_FLAG_OFF_LOCK,
TRMENU_LAYER_FLAG_OFF_CHECKED,

//ツールバー用
TRMENU_LAYER_TB_MOVE_UP = 2900,
TRMENU_LAYER_TB_MOVE_DOWN,

/* 表示 */

TRMENU_VIEW_MINIMIZE = 3000,
...
TRMENU_VIEW_RULE_GUIDE,
TRMENU_VIEW_TOOLBAR,
TRMENU_VIEW_STATUSBAR,
TRMENU_VIEW_CURSOR_POS,
TRMENU_VIEW_LAYER_NAME,
TRMENU_VIEW_CANVAS_ZOOM,
TRMENU_VIEW_CANVAS_ROTATE,
TRMENU_VIEW_BOXSEL_POS,

TRMENU_VIEW_PANEL_ALL_WINDOW = 3100,
TRMENU_VIEW_PANEL_ALL_STORE,
TRMENU_VIEW_PANEL_TOOL,
TRMENU_VIEW_PANEL_TOOL_LIST,
TRMENU_VIEW_PANEL_BRUSHOPT,
TRMENU_VIEW_PANEL_OPTION,
TRMENU_VIEW_PANEL_LAYER,
TRMENU_VIEW_PANEL_COLOR,
TRMENU_VIEW_PANEL_COLOR_WHEEL,
TRMENU_VIEW_PANEL_COLOR_PALETTE,
TRMENU_VIEW_PANEL_CANVAS_CTRL,
TRMENU_VIEW_PANEL_CANVAS_VIEW,
TRMENU_VIEW_PANEL_IMAGE_VIEWER,
TRMENU_VIEW_PANEL_FILTER_LIST,

TRMENU_VIEW_CANVASZOOM_UP = 3200,
TRMENU_VIEW_CANVASZOOM_DOWN,
TRMENU_VIEW_CANVASZOOM_ORIGINAL,
TRMENU_VIEW_CANVASZOOM_FIT,

TRMENU_VIEW_CANVASROTATE_LEFT = 3300,
...
TRMENU_FILTER_ID_TOP = 5100,
TRMENU_FILTER_ID_BOTTOM = 5999,

TRMENU_FILTER_TOP_COLOR = 5000,
...
TRMENU_FILTER_COMIC_AMITONE_CREATE,
TRMENU_FILTER_COMIC_TO_AMITONE,
TRMENU_FILTER_COMIC_SAND_TONE,
